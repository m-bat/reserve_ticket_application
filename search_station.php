...
if(is_array($_POST['station'])) {
$sql = "SELECT e.id, e.title, to_char(e.date, 'YYY年MM月DD日'), m.login_name, s.name FROM event e, member m, station s WHERE e.host = m.id and (e.station = s.id and ";
...
$sql .= "e.station = $station and e.station = s.id ";
$i++;
}
